...
public class ControllerConfig {
	...
	public static final int NUMB_TURN = 4;
	public static final double LONGITUDE_MIN = 45.730603;
	public static final double LONGITUDE_MAX = 45.787363;
	public static final double LATITUDE_MIN = 4.793432;
	public static final double LATITUDE_MAX = 4.894026;
	...
	public static ArrayList<Coord> generateCoordForDetectors() {
		...
		for (int i = 0; i < NUMB_SENSOR_Y; i++) {
			for (int j = 0; j < NUMB_SENSOR_X; j++) {
				coordForDetectors.add(new Coord(Precision.round(LONGITUDE_MIN + STEP_X/2 + j * STEP_X, 7), Precision.round(LATITUDE_MIN + STEP_Y/2 + i * STEP_Y, 7)));
			}
		}
